...
<head>
    ...
    <meta property="og:url" content="https://prestigecars.co.id/" />
    <meta property="og:site_name" content="Lestari Mobilindo" />
    <meta name="twitter:card" content="summary_large_image" />
    <meta name="twitter:label1" content="Est. reading time" />
    <meta name="twitter:data1" content="2 minutes" />

    <link href='https://fonts.gstatic.com/' crossorigin rel='preconnect' />
    <link rel="alternate" type="application/rss+xml" title="Lestari Mobilindo &raquo; Feed" href="feed/index.html" />
...
<body class="@yield('bodyClass')">
    ...
    <div id="wrapper" class="open">
        ...
        <div class="page-wrapper-inner">
            ...
            <header id="header"
                class="header site-header header-custom sticky-display-top megamenu-fullwidth megamenu-column-animation">
                                        ...
                                        <ul class="sub-menu">
                                            ...
                                            @foreach ($brand as $res=>$v )
                                                ...
                                                <a href="/brand/{{ $v->id }}"><span class="item-thumb"><img
                                                            ...
                                                            data-src="/img/brand/{{ $v->logo }}"
                                                            data-sizes="(max-width: 768px) 100vw, 768px"
                                                            data-srcset="/img/brand/{{ $v->logo }} 768w, /img/brand/{{ $v->logo }} 300w, /img/brand/{{ $v->logo }} 150w, /img/brand/{{ $v->logo }} 896w" /></span><span
                                                        class="item-caption">{{ $v->name }}</span></a></li>
                                            @endforeach
                                        </ul>
                                    </li>
                ...
                <div class="header-mobile logo-center">
                    <div class="header-contents container">
                        ...
                        <div class="hamburger-menu">
                            <button class="menu-toggle mobile-toggle" data-target="mobile-menu"><span
                                    class="bars"><svg xmlns="http://www.w3.org/2000/svg" width="24"
        ...
        <footer id="colophon" class="footer site-footer dark">
                        ...
                        <div class="other-columns col">
                            <div class="row">
                                ...
                                <div class="col-12 col-lg-4 col-md-6 footer1">
                                    ...
                                    <div id="et_social_media_widget-5"
                                        class="widget cf et_widget et_widget_social_media">
                                        <h2 class="widgettitle">Follow Us</h2>

                                        <div class="social_widget">
                                            <div class="intro-text">Our Social Media</div>
                                            <ul class="social-icons">
                                                <li><a href="https://web.facebook.com/ChandraLestarimobilindo/?_rdc=1&_rdr"
                                                        title="facebook" target="_blank"><span
                                                            class="et-icon et-facebook"></span></a></li>
                                                <li><a href="https://www.instagram.com/lestari_mobilindo/"
                                                        title="instagram" target="_blank"><span
                                                            class="et-icon et-instagram"></span></a></li>
                                                <li><a href="https://www.youtube.com/@lestarimobilindo5395"
                                                        title="youtube" target="_blank"><span
                                                            class="et-icon et-youtube"></span></a></li>
                                                <li><a href="https://wa.me/+6281282224440" title="whatsapp"
                                                        target="_blank"><span class="et-icon et-whatsapp"></span></a>
                                                </li>
                                            </ul>
                                        </div>
            ...
            <div id="footer-bar"
                class="footer-bar footer-main footer-normal light footer-bar-border-1 custom-color-1">
                <div class="container">
                    <div class="footer-items footer-left">
                        <div class="footer-bar-content copyright">
                            <p>Copyright © 2022 Lestari Mobilindo. All Right Reserved.</p>
                        </div>
                    </div>
    ...
    <div class="wp-bottom-menu" id="wp-bottom-menu">
        ...
        <a href="/" class="wp-bottom-menu-item {{ Request::is('/') ? 'active' : ''}}">
    ...
    <style type="text/css">
        ...
        :root {
            ...
            --wpbottommenu-h-icon-color: #0f95d8;
    ...
    <a href="#" title="Scroll To Top" id="scroll_to_top"><span class="arrow-top"><svg
    ...
    <nav id="mobile-menu" class="side-panel side-menu side-mobile-menu dark no-bar">
        ...
        <div class="side-panel-content side-panel-mobile custom_scroll">
            <div class="container">
                ...
                <div id="mobile-menu-container" class="menu-new-menu-container">
                                ...
                                @foreach ($brand as $res=>$val)
                                    <li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-{{ $val->id }} "><a
                                            href="/brand/{{ $val->id }}"><span class="item-thumb"><img
                                                    ...
                                                    class="attachment-medium_large size-medium_large et-lazyload lazyload"
                                                    alt="" decoding="async" loading="lazy"
                                                    data-src="/img/brand/{{ $val->logo }}"
                                                    data-sizes="(max-width: 768px) 100vw, 768px"
                                                    data-srcset="/img/brand/{{ $val->logo }} 768w, /img/brand/{{ $val->logo }} 300w, /img/brand/{{ $val->logo }} 150w, /img/brand/{{ $val->logo }} 896w" /></span><span
                                                class="item-caption">{{ $val->name }}</span></a><span
                                            class="et-menu-toggle">
                                        </span>
                                    </li>
                                @endforeach
                            </ul>
    ...
    <a class="qlwapp-toggle" data-action="open" data-phone="+6282278442800" data-message="Hi, My name is (your name), i&#039;m a visitor from your website. I&#039;d want to inquire about (name of the item) is it ready stock / indent? Thank you very much." href="javascript:void(0);" target="_blank">
    ...
    <script id='jquery-yith-wcwl-js-extra'>
        var yith_wcwl_l10n = {
            ...
            "hide_add_button": "1",
            "enable_ajax_loading": "",
            "ajax_loader_url": "assets\/plugins\/yith-woocommerce-wishlist\/assets\/images\/ajax-loader-alt.svg",
            ...
            "nonce": {
                "add_to_wishlist_nonce": "e28556e506",
                "remove_from_wishlist_nonce": "b01be96437",
                "reload_wishlist_and_adding_elem_nonce": "cfe25150b3",
                "load_mobile_nonce": "e738c916a9",
                "delete_item_nonce": "54d0e4c28e",
                "save_title_nonce": "ff6f048549",
                "save_privacy_nonce": "1f9db5afc6",
                "load_fragments_nonce": "f85aa82d0c"
            }
        };
    </script>


    <script src='/assets/plugins/wp-bottom-menu/inc/main370e.js?ver=1.4.3' id='wp-bottom-menu-js-js'></script>
    <script src='/assets/js/imagesloaded.mineda1.js?ver=4.1.4' id='imagesloaded-js'></script>

    {{-- ================================= Goya Themes ============================ --}}
    <script src='/assets/themes/goya/assets/js/vendor/lazysizes.min9a8d.js?ver=5.3.0' id='lazy-sizes-js'></script>
    <script src='/assets/themes/goya/assets/js/vendor/modernizr.minf7ff.js?ver=2.8.3' id='modernizr-js'></script>
    <script src='/assets/themes/goya/assets/js/vendor/mobile-detect.min9e1e.js?ver=1.3.2' id='mobile-detect-js'></script>
    <script src='/assets/themes/goya/assets/js/vendor/isInViewport.min459e.js?ver=3.0.4' id='in-viewport-js'></script>
    <script src='/assets/themes/goya/assets/js/vendor/perfect-scrollbar.jquery.min23b5.js?ver=0.8.0' id='perfect-scrollbar-js'></script>
    <script src='/assets/themes/goya/assets/js/vendor/arrive.min8066.js?ver=2.4.1' id='arrive-js'></script>
    <script src='/assets/themes/goya/assets/js/vendor/sliding-menu.min3958.js?ver=0.2.1' id='sliding-menu-js'></script>
    {{-- ========================================================================== --}}

    <script src='/assets/js/underscore.mind584.js?ver=1.13.4' id='underscore-js'></script>

    <script src='/assets/js/wp-util.min6a4d.js?ver=6.1.1' id='wp-util-js'></script>
    <script src='/assets/plugins/woocommerce//assets/js/frontend/add-to-cart-variation.min3781.js?ver=6.2.2' id='wc-add-to-cart-variation-js'></script>
    <script id='goya-app-js-extra'>
        var goya_theme_vars = {
            ...
            "settings": {
                "current_url": "https:\/\/prestigecars.co.id\/",
                "site_url": "https:\/\/prestigecars.co.id",
    ...
    <script src='/assets/plugins/wp-whatsapp-chat//assets/frontend/js/frontend3a8d.js?ver=021fa4de1c6ea4db860e85f702082b24' id='qlwapp-js'></script>
    <script id='woo-variation-swatches-js-extra'>
        var woo_variation_swatches_options = {
            "is_product_page": "",
            "show_variation_label": "1",
            "variation_label_separator": ":",
            "wvs_nonce": "110b3c8473"
        };
    </script>
    <script src='/assets/plugins/woo-variation-swatches//assets/js/frontend.min573a.js?ver=1.1.19' id='woo-variation-swatches-js'></script>
    <script src='/assets/plugins/js_composer//assets/js/dist/js_composer_front.min8e94.js?ver=6.8.0' id='wpb_composer_front_js-js'></script>
